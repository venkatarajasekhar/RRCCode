...
Eigen::MatrixXd Sensor::sensorMeasurementMatrix(const Position &sensorPos, const Field &field) const {
    Eigen::MatrixXd cMatrix = Eigen::MatrixXd::Zero(1, field.fieldDimension());
